...
int main(void)
{
	...
	// pi = 3.1415926 // These are the vvarious values of 32 bit HEX numbers, which were tested using ATXmega.
	// 0x3f9d70a4
	// 0x12345678
	...
	*/
	...
	char buff2[10];						// Decalring the 2nd buffer for string, to be used later.

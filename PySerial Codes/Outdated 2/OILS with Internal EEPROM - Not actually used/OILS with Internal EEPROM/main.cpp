/*
 * OILS with Internal EEPROM.cpp
 *
 * Created: 11-02-2019 20:00:07
 * Author : Neilabh
 */ 
...
#define TEST_BYTE_ADDR_a 0X00
#define TEST_BYTE_ADDR_b 0X01
#define TEST_BYTE_ADDR_c 0X02
#define TEST_BYTE_ADDR_d 0X03
...
int main(void)
{
	...
	/*
	uint8_t a = 0x00;					// These are the received data from the Python Console, stored in a, b, c and d.
	uint8_t b = 0x00;
	uint8_t c = 0x40;
	uint8_t d = 0x40;
	*/
